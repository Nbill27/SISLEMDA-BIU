<div class="row">
    <div class="col-xl-12">
        <h2 class="mb-4 mt-4">Edit Fakultas</h2>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="post" action="<?= site_url('admins/kelolafakultas/edit_fakultas/' . $fakultas['id_fakultas']); ?>">
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               id="nama_fakultas"
                               name="nama_fakultas"
                               value="<?= set_value('nama_fakultas', $fakultas['nama_fakultas']); ?>"
                               required>
