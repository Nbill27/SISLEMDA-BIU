...
<div class="container my-4">
    ...
    <div class="card shadow-sm rounded-4">
        <div class="card-body">
            ...
            <div class="row mt-4">
                <div class="col-md-6">
                    <a href="<?= site_url('users/riwayatpengajuan') ?>" class="btn btn-secondary btn-sm">
                        Kembali
                    </a>
                    <a href="<?= site_url('users/riwayatpengajuan/unduh_riwayat/' . $arsip->id_pengajuan) ?>" target="_blank" class="btn btn-success btn-sm">
                        Unduh Disposisi
                    </a>
                </div>
            </div>
